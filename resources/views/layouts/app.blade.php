            ...
            <nav class="mt-10">
                ...
                <div class="relative group">
                    ...
                    <div id="hrmDropdown" class="hidden mt-2 py-2 w-full bg-gray rounded-lg shadow-lg">
                        ...
                        <a href="{{ route('salary.index') }}" class="block px-4 py-2 text-gray-100 hover:bg-gray-700 {{ request()->routeIs('salary.index.*') ? 'active-menu' : '' }}">Salary Grade</a>
                        <a href="{{ route('loanns.index') }}" class="block px-4 py-2 text-gray-100 hover:bg-gray-700 {{ request()->routeIs('loanns.*') ? 'active-menu' : '' }}">Employee Loan</a>
                ...
                <div class="relative group">
                    <a
                       class="flex menu-link items-center px-6 py-2 mt-4 text-gray-500 group-hover:bg-gray-700 group-hover:bg-opacity-25 group-hover:text-gray-100 cursor-pointer {{ request()->routeIs('timesheets.*', 'leave.*', 'attendances.*') ? 'active-menu' : '' }}"
                ...
                <div class="relative group">
                    ...
                    <a
                       class="flex items-center px-6 py-2 mt-4 text-gray-500 group-hover:bg-gray-700 group-hover:bg-opacity-25 group-hover:text-gray-100 cursor-pointer {{ request()->routeIs('salary.*', 'payslip.*', 'set.salary.index') ? 'active-menu' : '' }}"
                    ...
                    <div id="payrollDropdown" class="hidden mt-2 py-2 w-full bg-gray rounded-lg shadow-lg">
                        ...
                        <a href="{{ route('set.salary.index') }}" class="block px-4 py-2 text-gray-100 hover:bg-gray-700 {{ request()->routeIs('salary.*') ? 'active-menu' : '' }}">Set Salary</a>
