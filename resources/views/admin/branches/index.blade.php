            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="py-2 px-4 text-center border-b">
                        <a href="{{ route('branches.show', $branch->id) }}" class="text-blue-500 hover:underline mr-2"><i class="fa-solid fa-eye"></i></a>
                        <a href="{{ route('branches.edit', $branch->id) }}" class="text-yellow-500 hover:underline mr-2"><i class="fa-solid fa-pen-to-square"></i></a>
