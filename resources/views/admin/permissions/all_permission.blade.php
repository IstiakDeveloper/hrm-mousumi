...
<div class="container mx-auto py-4">
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex justify-end">
            ...
            <a href="#" class="bg-red-500 text-white py-2 px-4 m-2 rounded hover:bg-blue-600">Export</a>
        </div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="py-2 px-4 text-center">
                    <a href="{{ route('permission.edit', $item->id) }}" class="text-yellow-500 hover:underline">Edit</a>
